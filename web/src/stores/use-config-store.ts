...
export const defaultConfig: AiConfig = {
    ...
    model: "modelhub::gpt-image-2",
    imageModel: "modelhub::gpt-image-2",
    videoModel: "modelhub::seedance-2.0-mini",
    textModel: "",
    audioModel: "",
    audioVoice: "alloy",
    audioFormat: "mp3",
    ...
    models: ["modelhub::gpt-image-2", "modelhub::seedance-2.0-mini", "modelhub::seedance-2.0", "modelhub::seedance-2.5"],
    quality: "auto",
    size: "1:1",
    background: "",
    count: "1",
